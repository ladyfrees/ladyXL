...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        let gif = "https://th.bing.com/th/id/R.d2a93c241d886a9ea9800842e13b429e?rik=WNyPeJmtX7Msbw&pid=ImgRaw&r=0.gif";
        ...
        .addFields(
            {
                name: `⁉ Como funciona?`,
                value: `\`!ship (usuario)\` o \`!ship (usuario 1) (usuario 2)\``,
                inline: false
            },
            {
                name: `🤓 Explicación:`,
                value: `El bot enviará dos usuarios elegidos por ti.`,
                inline: false
            }
        );
